...
@WebServlet("/updatePlayerSelection")
public class updatePlayerSelectionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        roomToDisplay.getGameManager().updateCurrPlayerWithSelection(actionToDo,num);
