...
public class JoinRoomServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String gameTitleFromParameter = request.getParameter(GAME_TITLE);

        System.out.println("User: "+ usernameFromSession +" join room: "+gameTitleFromParameter);
        PrintWriter out = response.getWriter();
        out.print(gameTitleFromParameter);
